    ...
    return {
      ...
      body: JSON.stringify({
        ...
        sources: [
          ...
          { name: 'WebLLM (Microsoft Phi-4 Mini)', category: 'AI vehicle valuation', url: 'https://github.com/mlc-ai/web-llm', note: 'In-browser AI provides vehicle value, insurance group, and personalized insights.' },
